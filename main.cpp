...
int main() {
    ...
    double V0 = 70.5;           // Начальная скорость, м/с
    double theta_c0 = 40.0;     // Начальный угол наклона траектории, град (почти вертикально)
    double m_dot = 86.0;        // Массовый секундный расход, кг/с
    double W = 2245.0;          // Скорость истечения газов ДУ, м/с
    double y0 = 3401.0;         // Начальная высота, м
    double omega_z0 = 0.035;      // Начальная угловая скорость вращения, с^-1
    double theta0 = theta_c0;   // Начальный угол тангажа, град
    double t_end = 3.57;        // Продолжительность активного участка, с
